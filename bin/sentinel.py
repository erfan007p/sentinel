...
def attempt_superblock_creation(gobyted):
    ...
    maxgovobjdatasize = gobyted.govinfo['maxgovobjdatasize']
    sb = gobytelib.create_superblock(proposals, event_block_height, budget_max, sb_epoch_time, maxgovobjdatasize)
    if not sb:
