...
Sentinel is an autonomous agent for persisting, processing and automating GoByte governance objects and tasks, and for expanded functions in the upcoming GoByte V13 release (Evolution).

Sentinel is implemented as a Python application that binds to a local version 12 gobyted instance on each GoByte Masternode.
